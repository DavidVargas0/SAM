...
namespace  SAM.Geometry.Object.Spatial
{
    public static partial class Create
    {
        ...
        {
            List<Face2D> face2Ds_SolarFace = Geometry.Planar.Query.Union(face2Ds, tolerance);
            ...
            foreach (Face2D face2D_SolarFace in face2Ds_SolarFace)
            {
                ...
                List<Face2D> face2Ds_Shade = Geometry.Planar.Query.Intersection(face2D, face2D_Shade);
