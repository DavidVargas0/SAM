 ...
 // namespace  SAM.Analytical
{
    ...
    {
        public static void SimplifyByAngle(this BuildingModel buildingModel, double tolerance_Angle = Tolerance.Angle, double tolerance_Distance = Tolerance.Distance)
        {
