 ...
 // namespace  SAM.Analytical
{
    public static partial class Query
    {
        ...
        public static List<IPartition> OrientedPartitions(this BuildingModel buildingModel, Space space, bool includeOpenings, out List<IPartition> flippedPartitions, bool external = true, double silverSpacing = Tolerance.MacroDistance, double tolerance = Tolerance.Distance)
        {
        ...
        public static List<IPartition> OrientedPartitions(this BuildingModel buildingModel, Space space, bool includeOpenings, bool external = true, double silverSpacing = Tolerance.MacroDistance, double tolerance = Tolerance.Distance)
        {
