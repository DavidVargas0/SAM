 ...
 // namespace  SAM.Analytical
{
    ...
    {
        public static List<Panel> SplitByInternalEdges(this Panel panel, double tolerance = Tolerance.Distance)
        {
            if (panel == null)
                return null;
        ...
        public static AdjacencyCluster SplitByInternalEdges(this AdjacencyCluster adjacencyCluster, double tolerance = Tolerance.Distance)
        {
