 ...
 // namespace  SAM.Analytical
{
    ...
    {
        public static Panel SnapByIntersections(this Panel panel, IEnumerable<ISegmentable3D> segmentable3Ds, double maxTolerance = Tolerance.MacroDistance, double minTolerance = Tolerance.MicroDistance)
        {
